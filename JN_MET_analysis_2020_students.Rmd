...
#setwd("/Users/au651723/OneDrive_Aarhus_universitet/Aarhus/Intro_Cog_Neuro/Class_160420") # change this
library(readxl)
MET2020 <- read.csv("Musical Ear Test 2020.csv") # change this to wherever you put the MET scores
#head(tegneData)

MET2020<-MET2020[1:45,]
...
METscore$musician<-factor(MET2020$Are.you.currently.playing.an.instrument..min..one.hour.per.week..,labels=c('non','musicians'))
METscore$ID<-factor(MET2020$ID)
METscore$age<-MET2020$Age
